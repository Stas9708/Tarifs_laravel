...
Route::post('/table/store', [\App\Http\Controllers\TableController::class, 'store'])->name(name: 'table.store');
Route::get('/table/store', [\App\Http\Controllers\TableController::class, 'store'])->name('table.paginate');
